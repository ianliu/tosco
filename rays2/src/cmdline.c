  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* number samples in x (for exporting the velocity model).  */
          ...
          /* number samples in z (for exporting the velocity model).  */
