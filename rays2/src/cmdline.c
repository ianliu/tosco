...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->nofill_help = gengetopt_args_info_help[6] ;
  args_info->palette_help = gengetopt_args_info_help[7] ;
  args_info->land_help = gengetopt_args_info_help[8] ;
  args_info->blackrays_help = gengetopt_args_info_help[9] ;
  args_info->norays_help = gengetopt_args_info_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVp:lb", long_options, &option_index);
