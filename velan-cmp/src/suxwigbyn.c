 ...
 *
 *
 * This program is based on source code of program suxwigb
 * distributed in Seismic Un*x package.
 * AUTHOR: Jack Cohen and John Stockwell, Colorado School of Mines
