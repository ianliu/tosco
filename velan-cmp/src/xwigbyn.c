 ...
 *
 *
 * This program is based on source code of program xwigb
...
char *sdoc[] = {
"									",
" XWIGBYN - X WIGgle-trace plot of f(x1,x2) via Bitmap			",
"									",
" xwigbyn n1= [optional parameters] <binaryfile   	                ",
"									",
" X Functionality:							",
...
" y/n save an answer to confirm picks in a file			        ",
"									",
" Notes:								",
