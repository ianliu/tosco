		    ...
		    float ymin, float ymax)
{
	...
	fprintf (fp, "\n@g%i fixedpoint xy 0.000000, 0.000000",
		 AGR_graphindex);
	fprintf (fp, "\n@g%i fixedpoint format general general",
		 AGR_graphindex);
	fprintf (fp, "\n@g%i fixedpoint prec 6, 6", AGR_graphindex);
	fprintf (fp, "\n@with g%i", AGR_graphindex);
	fprintf (fp, "\n@    world %.5f, %.5f, %.5f, %.5f ", xmin, ymin,
		 xmax, ymax);
	fprintf (fp, "\n@    stack world 0, 0, 0, 0");
	fprintf (fp, "\n@    znorm 1");
	fprintf (fp, "\n@    view %.3f, %.3f, %.3f, %.3f",
	...
	fprintf (fp, "\n@    xaxis  bar linewidth %3.1f",
		 AGR_xaxislinewidth);
	fprintf (fp, "\n@    xaxis  label \"%s\"", AGR_xaxislabel);
	fprintf (fp, "\n@    xaxis  label layout para");
	fprintf (fp, "\n@    xaxis  label place auto");
	fprintf (fp, "\n@    xaxis  label char size %8.6f",
		 AGR_xaxislabelcharsize);
	...
	fprintf (fp, "\n@    xaxis  ticklabel place %s",
		 AGR_xaxisticklabelplace);
	...
	fprintf (fp, "\n@    yaxis  bar linewidth %3.1f",
		 AGR_yaxislinewidth);
	fprintf (fp, "\n@    yaxis  label \"%s\"", AGR_yaxislabel);
	fprintf (fp, "\n@    yaxis  label layout para");
	fprintf (fp, "\n@    yaxis  label place auto");
	fprintf (fp, "\n@    yaxis  label char size %8.6f",
		 AGR_yaxislabelcharsize);
	...
	fprintf (fp, "\n@    frame background color %i",
		 AGR_framebackgroundcolor);
...
void WriteAGRPalette (FILE * fp)
{
	...
	for (i = 0; i < AGR_numberofcolors; i++) {
		fprintf (fp, "\n@map color %i to (%3i, %3i, %3i), \"%s\"",
			 ...
			 AGR_palette[i][0],
			 AGR_palette[i][1],
			 AGR_palette[i][2], AGR_colorname[i]);
	}
}
...
void SetAGRDefaultPalette ()
{
	...
	AGR_palette =
	    (unsigned short **) malloc (AGR_numberofcolors *
	...
	AGR_palette[9][1] = 255;
	AGR_palette[9][2] = 255;
	AGR_palette[10][0] = 255;
	AGR_palette[10][1] = 0;
	AGR_palette[10][2] = 255;
	AGR_palette[11][0] = 255;
	AGR_palette[11][1] = 165;
	AGR_palette[11][2] = 0;
	AGR_palette[12][0] = 114;
	AGR_palette[12][1] = 33;
	AGR_palette[12][2] = 188;
	AGR_palette[13][0] = 103;
	AGR_palette[13][1] = 7;
	AGR_palette[13][2] = 72;
	AGR_palette[14][0] = 64;
	AGR_palette[14][1] = 224;
	AGR_palette[14][2] = 208;
	AGR_palette[15][0] = 0;
	AGR_palette[15][1] = 139;
	AGR_palette[15][2] = 0;
	AGR_palette[16][0] = 105;
	AGR_palette[16][1] = 128;
	AGR_palette[16][2] = 144;
	AGR_palette[17][0] = 105;
	AGR_palette[17][1] = 105;
	AGR_palette[17][2] = 105;
	AGR_palette[18][0] = 47;
	AGR_palette[18][1] = 79;
	AGR_palette[18][2] = 79;
	AGR_palette[19][0] = 70;
	AGR_palette[19][1] = 130;
	AGR_palette[19][2] = 180;
	AGR_palette[20][0] = 95;
	AGR_palette[20][1] = 158;
	AGR_palette[20][2] = 160;
	AGR_palette[21][0] = 102;
	AGR_palette[21][1] = 205;
	AGR_palette[21][2] = 170;
	AGR_palette[22][0] = 0;
	AGR_palette[22][1] = 100;
	AGR_palette[22][2] = 0;
	AGR_palette[23][0] = 85;
	AGR_palette[23][1] = 107;
	AGR_palette[23][2] = 47;
	AGR_palette[24][0] = 143;
	AGR_palette[24][1] = 188;
	AGR_palette[24][2] = 143;
	AGR_palette[25][0] = 46;
	AGR_palette[25][1] = 139;
	AGR_palette[25][2] = 87;
	AGR_palette[26][0] = 189;
	AGR_palette[26][1] = 183;
	AGR_palette[26][2] = 107;
	AGR_palette[27][0] = 238;
	AGR_palette[27][1] = 232;
	AGR_palette[27][2] = 170;
	AGR_palette[28][0] = 218;
	AGR_palette[28][1] = 165;
	AGR_palette[28][2] = 32;
	AGR_palette[29][0] = 184;
	AGR_palette[29][1] = 134;
	AGR_palette[29][2] = 11;
	AGR_palette[30][0] = 255;
	AGR_palette[30][1] = 140;
	AGR_palette[30][2] = 0;
	AGR_palette[31][0] = 58;
	AGR_palette[31][1] = 95;
	AGR_palette[31][2] = 205;
	AGR_palette[32][0] = 205;
	AGR_palette[32][1] = 181;
	AGR_palette[32][2] = 205;
	AGR_palette[33][0] = 102;
	AGR_palette[33][1] = 102;
	AGR_palette[33][2] = 102;
	AGR_palette[34][0] = 127;
	AGR_palette[34][1] = 127;
	AGR_palette[34][2] = 127;
	AGR_palette[35][0] = 153;
	AGR_palette[35][1] = 153;
	AGR_palette[35][2] = 153;
	AGR_palette[36][0] = 179;
	AGR_palette[36][1] = 179;
	AGR_palette[36][2] = 179;
