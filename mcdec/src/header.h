...
/*
 * Macro: SIZEOF_SEGYHDR
 * Tamanho em bytes do header de um traço sísmico no formato SU.
 */
 ...
 * Traço sísmico.
 *
 * Estrutura para armazenar um traço sísmico. Similar ao tipo segy do
 * SU, porém com cinco campos extras para armazenar as posições de
 * fonte, receptor e coordenada de ponto médio em metroso, além vetor
 * de amplitures ser armazenado dinamicamente.
 */
...
/*
 * Macro: WRT_HDR
 * Escreve o header de um traço num arquivo.
 */
#define WRT_HDR(fp,tr)    fwrite((void *) (tr), SIZEOF_SEGYHDR, 1, (fp))

/*
 * Macro: WRT_DTA
 * Escreve ns amostras de um traço num arquivo.
 */
#define WRT_DTA(fp,data,ns) fwrite((void *) data, sizeof(float), (ns), (fp))
